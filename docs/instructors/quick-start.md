...
- you are testing whether Avida-ED fits a course before adopting more of the
  curriculum

## Before class

1. Decide whether your students should use Avida-ED 4 or a legacy pathway.
   In most cases, start with the current [Launch Avida-ED](/app) page and use
   Avida-ED 4.
