...
<nav className="pageSubnav" aria-label="Help page sections">
  <span className="pageSubnav__crumb" aria-current="page">Help</span>
  <a href="#common-starting-points">Starting points</a>
...
Use this checklist when Avida-ED does not launch or assignment workflow steps
fail.

### If the app does not launch

- Confirm you started from [Launch Avida-ED 4](/app).
...
2. [Lab Manual](/curriculum/lab-manual)
3. [Model Lessons](/curriculum/model-lessons)
